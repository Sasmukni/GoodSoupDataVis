...
})
{
    ...
    <div>
        ...
        {dataForGroupedBarChart.length && category === "Barchart" &&
            <GroupedBarChart data={dataForGroupedBarChart[0].data} width={width-30}/>
        }
        {dataForHeatMap.length && category === "Heatmap" &&
            <HeatMap data={dataForHeatMap[0].data} width={width}/>
        }
        {dataForDumbell.length && category === "Dumbell" &&
            <DumbbellPlot data={dataForDumbell[0].data} width={width}/>
        }
        </>
        :
        <div>
